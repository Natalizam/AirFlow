...
with DAG(
    ...
    description="**Lesson 4** надеюсь *этот код* здесь отработает #я уже '7' раз пытался, но похоже #не там",
    schedule_interval=timedelta(days=1),
    start_date=datetime(2022, 1, 1),
    catchup=False,
    """**Lesson 4** надеюсь *этот код* здесь отработает #я уже '7' раз пытался, но похоже #не там""",
    tags=['les4'],
) as dag:
    for i in range(10):
        t1 = BashOperator(
